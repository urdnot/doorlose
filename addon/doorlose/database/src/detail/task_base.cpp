...
task_base::task_base(const std::uint64_t max_task_size, const std::uint64_t granularity)
{
    ...
    // Checks
    //
    check_non_zero(max_task_size, "task_base::init(): `task_size` cannot be zero");
    check_non_zero(granularity, "task_base::init(): `granularity` cannot be zero");
    check_mult(max_task_size, 4, "task_base::init(): `task_size` should be multiple of 4 for alignment");
    //check_mult(capacity, granularity, "task_base::init(): `capacity` should be multiple of `granularity`");
